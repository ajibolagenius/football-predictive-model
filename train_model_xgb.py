...
def train_v4():
    ...
    # NEW TACTICAL FEATURES ADDED
    features = [
        'elo_diff', 
        'home_rest', 'away_rest',
        'home_ppda_5', 'away_ppda_5',   # Tactics: Pressing
        'home_deep_5', 'away_deep_5',   # Tactics: Box Entries
        'home_xg_5', 'away_xg_5'        # Tactics: Chance Quality
    ]
